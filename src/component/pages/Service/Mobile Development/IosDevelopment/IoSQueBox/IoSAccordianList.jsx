...
import {
  IoSQueAccordionData,
  IoSQueAccordionDataSecond,
} from '../../../../../../common/AccordianSection/Accordian';

function IoSAccordianList({ handleToggle, toggle }) {
  return (
    <>
      <div className='col-sm-12 col-lg-6'>
        {IoSQueAccordionData.map((value) => {
      ...
      <div className='col-sm-12 col-lg-6'>
        {IoSQueAccordionDataSecond.map((value) => {
          const { id, qn, ans, heading, info } = value;
          return (
            <div
              className='card px-3 mt-20 border_none'
...
export default IoSAccordianList;
