...
import {
  WebQueAccordionData,
  WebQueAccordionDataSecond,
} from '../../../../../../common/AccordianSection/Accordian';

function WebAccordianList({ handleToggle, toggle }) {
  return (
    <>
      <div className='col-sm-12 col-lg-6'>
        {WebQueAccordionData.map((value) => {
      ...
      <div className='col-sm-12 col-lg-6'>
        {WebQueAccordionDataSecond.map((value) => {
          const { id, qn, ans, heading, info } = value;
          return (
            <div
              className='card   px-3 mt-20 border_none'
...
export default WebAccordianList;
