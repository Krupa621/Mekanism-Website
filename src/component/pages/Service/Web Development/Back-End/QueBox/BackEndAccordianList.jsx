...
import {
  BackEndQueAccordionData,
  BackEndQueAccordionDataSecond,
} from '../../../../../../common/AccordianSection/Accordian';

function BackEndAccordianList({ handleToggle, toggle }) {
  return (
    <>
      <div className='col-sm-12 col-lg-6'>
        {BackEndQueAccordionData.map((value) => {
      ...
      <div className='col-sm-12 col-lg-6'>
        {BackEndQueAccordionDataSecond.map((value) => {
          const { id, qn, ans, heading, info } = value;
          return (
            <div
              className='card   px-3 mt-20 border_none'
...
export default BackEndAccordianList;
