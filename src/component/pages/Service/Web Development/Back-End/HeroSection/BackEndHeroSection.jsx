    ...
    <div className='Hero_section mobileTitle'>
      <div className='d-flex flex-column justify-content-center py-3 serviceHeroPart'>
        <div className='d-flex align-items-center gap-2'>
          ...
          <p className='content_para_info fw-4 footer-detail-color m-0'>
        ...
        <p className='content_para fw-4 mb-40'>
          Get the most out of software’s server side with backend development
          services provided by an engineering team with proven skills and deep
          expertise
        </p>
        <div>
          <button
...
export default BackEndHeroSection;
