...
import { FrontEndCaseStudyContent } from '../../../../../../common/constant';

const FrontEndStudies = () => {
  return (
    <>
      <div className='container mx-auto'>
        {FrontEndCaseStudyContent?.map((item, index) => (
          <div key={index}>
              ...
              <div className='CaseStudyData align-items-center justify-content-center gap-4 row w-100 m-0'>
                ...
                <div className='col caseStudy_date py-4 px-3'>
                  <div className='d-flex justify-content-between mb-20'>
                    <p className='content_para fw-4 sub_content_light_color m-0'>
                      Under NDA
                    </p>
                    <p className='content_para fw-4 sub_content_light_color m-0'>
                      FinTech
                  ...
                  <div className='d-flex country_details justify-content-between'>
                    <p className='content_para fw-4 sub_head_color mb-10'>
                      Country
                    </p>
                    <p className='content_para fw-4 sub_head_color mb-10'>
                      Saudi Arabia
                  ...
                  <div className='d-flex tech_details justify-content-between'>
                    <p className='content_para fw-4 sub_head_color mb-10'>
                      Core tech
                    </p>
                    <p className='content_para fw-4 sub_head_color mb-10'>
...
export default FrontEndStudies;
