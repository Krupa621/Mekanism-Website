    ...
    <div className='Hero_section mobileTitle'>
      <div className='d-flex flex-column justify-content-center py-3 serviceHeroPart'>
        ...
        <p className='content_para fw-4 mb-40'>
          Cross platform mobile app development services help businesses speed
          up creation and launch a product with the lower cost
        </p>
        <div>
          <button
...
export default CrossHeroSection;
