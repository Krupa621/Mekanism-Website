...
import { AccordionDataSecond } from '../../../../../common/AccordianSection/Accordian';
          ...
          return (
            ...
            >
              ...
              >
                ...
                <h2 className='content_para'>{qn}</h2>
              </div>
              {id === toggle ? (
                <div className='card-body ms-4'>
                  ...
                  <ul>
                    {ans.map((item) => (
                      <li className='content_para fw-4 header_color'>
                        {item.listItemName}
                      </li>
                    ))}
                  </ul>
            ...
            >
              ...
              {id === toggle ? (
                <div className='card-body'>
                  <div>
                    <h2 className='content_para'>{heading}</h2>
                    <h2 className='content_para'>{info}</h2>
                  </div>
                  <ul>
                    {ans.map((item) => (
                      <li className='content_para'>{item.listItemName}</li>
                    ))}
                  </ul>
                </div>
              ) : (
