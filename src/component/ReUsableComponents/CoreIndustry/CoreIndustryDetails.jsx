...
import './CoreIndustyDetails.scss';

const CoreIndustryDetails = ({ title, contentItems }) => {
  return (
    <div className='contentBoxData'>
      <div className='CoreIndutryBox'>
        <div className='CoreIndustryWrapper'>
          <h3 className='sub_part_header'>{title}</h3>
          <svg
            width='10'
            height='10'
            viewBox='0 0 16 16'
...
export default CoreIndustryDetails;
